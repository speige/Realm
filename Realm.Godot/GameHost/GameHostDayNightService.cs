...
public class GameHostDayNightService
{
	...
	public (int TimeOfDayIndex, float TimeOfDayTimer) CycleTimeOfDay(Node3D host, int currentTimeOfDayIndex, float timeOfDayCycleDuration)
	{
		int nextIndex = (currentTimeOfDayIndex + 1) % 4;
		...
		float nextTimer = progress * timeOfDayCycleDuration;
