...
public partial class InGameHUD : Control
{
	...
	private void BuildHotkeyReferencePanel()
	{
		...
		var hotkeys = new (string key, string desc)[] {
			...
			("", ""),
			("Héroe Survivor:", ""),
			("Q",   "Bola de fuego (daño en área)"),
			("W",   "Rayo (daño en área)"),
			("E",   "Luz sagrada (cura en área)"),
			("A",   "Piedra de Daño (compra)"),
			("S",   "Piedra de Alcance (compra)"),
			("D",   "Furia de Flechas (compra)"),
			("F",   "Multidisparo (compra)"),
			("R",   "Healthstone (compra)"),
			("Z",   "Poción de Restauración (compra)"),
			("-help","Ver todas las mejoras en el chat"),
			("", ""),
			("Priest selected:", ""),
			("W",   "Cast Holy Light"),
